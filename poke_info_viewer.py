...
lbl_height.grid(row=0, column=0, padx=(10, 5), pady=5, sticky=E)

lbl_height_value = ttk.Label(frm_btm_left, text='TBD')
lbl_height_value.grid(row=0, column=1, padx=(5, 20), pady=5, sticky=W)
...
lbl_weight_value.grid(row=1, column=1, padx=(5, 20), pady=5, sticky=W)
...
lbl_type_value.grid(row=2, column=1, padx=(5, 20), pady=5, sticky=W)
...
bar_hp.grid(row=0, column=1, padx=(5, 5), pady=5, sticky=W)
...
bar_attack.grid(row=1, column=1, padx=(5, 5), pady=5, sticky=W)
...
bar_defense.grid(row=2, column=1, padx=(5, 5), pady=5, sticky=W)
...
bar_special_attack.grid(row=3, column=1, padx=(5, 5), pady=5, sticky=W)
...
bar_special_defense.grid(row=4, column=1, padx=(5, 5), pady=5, sticky=W)
...
bar_speed.grid(row=5, column=1, padx=(5, 5), pady=5, sticky=W)
